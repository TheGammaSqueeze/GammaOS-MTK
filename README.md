...
- **You may also want to install the Yuzu Controller fix Magisk module to ensure you don't have issues controlling games in Yuzu or other games. Module here: https://github.com/TheGammaSqueeze/GammaOS-MTK/blob/main/rgp2xbox_ktr1_yuzu_fix.zip**
